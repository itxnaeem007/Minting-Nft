...
const Main = () => {
    ...
    return (
        <div className='main' id="main">
            ...
            <p className='main-p-link'><a target="_blank" href={`https://etherscan.io/address/0xF839f36391D0328B04dEBa39892B7AD`}>0xF839f36391D03...</a></p>
            <p className='main-p-same'>1 NFT Costs .02 eth</p>
            <p className='main-p-same'>First 500 NFT are free!</p>
